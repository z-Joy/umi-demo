...
var _default = api => {
  ...
  api.onGenerateFiles({
    fn() {
      var _api$config$dva3, _api$config$dva4, _api$config$dva5, _api$config$dva6, _api$config, _api$config$dva8;
      ...
      api.writeTmpFile({
        ...
        content: Mustache.render(dvaTpl, {
          ...
          LazyLoad: (_api$config$dva6 = api.config.dva) === null || _api$config$dva6 === void 0 ? void 0 : _api$config$dva6.lazyLoad,
          RegisterModelImports: models.map((path, index) => {
            ...
            return ((_api$config$dva7 = api.config.dva) === null || _api$config$dva7 === void 0 ? void 0 : _api$config$dva7.lazyLoad) ? `const ${modelName} = (await import('${path}')).default;` : `import ${modelName} from '${path}';`;
          }).join('\r\n'),
...
app.model({ namespace: '${(0, _path().basename)(path, (0, _path().extname)(path))}', ...Model${lodash.upperFirst(lodash.camelCase((0, _path().basename)(path, (0, _path().extname)(path))))}${index} });
      ...
      api.writeTmpFile({
        ...
        content: Mustache.render(connectTpl, {
          dvaHeadExport: ((_api$config$dva8 = api.config.dva) === null || _api$config$dva8 === void 0 ? void 0 : _api$config$dva8.disableModelsReExport) ? `` : models.map(path => {
            // prettier-ignore
  ...
  api.modifyBabelOpts(babelOpts => {
    ...
    const hmr = (_api$config$dva9 = api.config.dva) === null || _api$config$dva9 === void 0 ? void 0 : _api$config$dva9.hmr;
